    ...
    <div className="min-h-screen bg-gray-100 p-4 pb-20">
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-4 space-y-3 animate-fade-in">
        ...
        <div className="rounded border bg-gray-50 p-3 text-xs text-gray-700 space-y-1">
          ...
          <div className="font-mono">partNo, price, diffN1, diffN2</div>
          <div className="text-[11px] text-gray-500 space-y-0.5">
            <div>
              <span className="font-medium">partNo</span> — part number
            </div>
            <div>
              <span className="font-medium">price</span> — unit price
            </div>
            <div>
              <span className="font-medium">diffN1</span> — difference from
              previous count (N-1)
            </div>
            <div>
              <span className="font-medium">diffN2</span> — difference from
              count before that (N-2)
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`flex-1 py-2 rounded text-white text-sm ${!file || uploading ? "bg-gray-400" : "bg-indigo-600"}`}
          >
