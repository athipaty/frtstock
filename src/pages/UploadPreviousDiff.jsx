            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-gray-50 text-gray-500">
                  ...
                  <th className="text-left px-3 py-2 font-semibold">diffN1</th>
                  <th className="text-left px-3 py-2 font-semibold">diffN2</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-50">
                  <td className="px-3 py-2 font-mono text-gray-700">ABC-001</td>
                  <td className="px-3 py-2 font-mono text-gray-700">250.00</td>
                  <td className="px-3 py-2 font-mono text-red-400">-10</td>
                  <td className="px-3 py-2 font-mono text-red-400">-5</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="px-3 py-2 font-mono text-gray-700">XYZ-002</td>
                  <td className="px-3 py-2 font-mono text-gray-700">180.00</td>
                  <td className="px-3 py-2 font-mono text-green-500">+20</td>
