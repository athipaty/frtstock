...
export default function UploadProductionParts() {
  ...
  const upload = async () => {
    ...
    try {
      ...
      const res = await axios.post(`${API}/count/production-parts`, form, {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 pb-20 md:pb-8">
      <div className="max-w-md md:max-w-2xl mx-auto space-y-4 animate-fade-in">
        ...
        {/* Header */}
        <div>
          <h1 className="text-lg md:text-2xl font-bold text-gray-800">Upload Production Parts</h1>
          <p className="text-xs md:text-sm text-gray-400 mt-0.5">
            Upload production part numbers to filter them out from inventory lists.
          </p>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-100 rounded-2xl p-4 flex gap-3">
          ...
          <div className="text-xs text-yellow-700 space-y-1">
            ...
            <div className="text-yellow-600">
              Any part number in this list will be filtered out from Variance, Matched, and Uncounted pages.
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-3">
            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-gray-50 text-gray-500">
                  <th className="text-left px-3 py-2 font-semibold rounded-lg">partNo</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-50">
                  <td className="px-3 py-2 font-mono text-gray-700">PROD-001</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="px-3 py-2 font-mono text-gray-700">PROD-002</td>
                </tr>
                <tr>
          ...
          <div className="text-xs text-gray-400">
            Each row represents one production part number to be filtered out.
          </div>
        </div>
          ...
          >
            ...
            {file ? (
              <div className="space-y-1">
                ...
                <div className="text-sm font-semibold text-yellow-600">{fileInfo.name}</div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500 mt-0.5">
                  <span className="font-medium text-gray-700">{result.inserted}</span> production parts uploaded successfully
                </div>
              </div>
            </div>
          </div>
