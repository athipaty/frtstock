...
export default function UploadProductionParts() {
  ...
  const upload = async () => {
    ...
    try {
      ...
      const res = await axios.post(`${API}/upload/production-parts`, form, {
  ...
  const clearAll = async () => {
    try {
      ...
      const res = await axios.delete(`${API}/upload/production-parts`);
      ...
      <div className="max-w-md md:max-w-2xl mx-auto space-y-4 animate-fade-in">
        ...
        <div>
          <h1 className="text-lg md:text-2xl font-bold text-gray-800">
            Upload Production Parts
          </h1>
          <p className="text-xs md:text-sm text-gray-400 mt-0.5">
            Upload production part numbers to filter them out from inventory
            lists.
          </p>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-100 rounded-2xl p-4 flex gap-3">
          ...
          <div className="text-xs text-yellow-700 space-y-1">
            ...
            <div className="text-yellow-600">
              Any part number in this list will be filtered out from Variance,
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm font-bold text-red-600">
                  Clear All Production Parts?
                </div>
                <div className="text-xs text-gray-500 mt-1">
                  This will permanently delete{" "}
                  <span className="font-semibold text-gray-700">
                    all production part records
                  </span>{" "}
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500 mt-0.5">
                  ...
                  production parts uploaded successfully
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500 mt-0.5">
                  ...
                  production parts removed from the system
                </div>
              </div>
            </div>
          </div>
