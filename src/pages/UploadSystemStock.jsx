...
export default function UploadSystemStock() {
  ...
  const clearAll = async () => {
    try {
      ...
      const res = await axios.delete(`${API}/upload/system-stock`);
      ...
      <div className="max-w-md md:max-w-2xl mx-auto space-y-4 animate-fade-in">
        ...
        <div>
          ...
          <p className="text-xs md:text-sm text-gray-400 mt-0.5">
            Upload system stock data to compare against physical counts.
          </p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-4 flex gap-3">
          ...
          <div className="text-xs text-blue-700 space-y-1">
            ...
            <div className="text-blue-500">
              System stock quantities are compared against physical counts to
              calculate variance, matched, and uncounted parts across all pages.
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-3">
            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-gray-50 text-gray-500">
                  <th className="text-left px-3 py-2 font-semibold rounded-l-lg">
                    partNo
                  </th>
                  <th className="text-left px-3 py-2 font-semibold rounded-r-lg">
                    qty
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-50">
                  ...
                  <td className="px-3 py-2 font-mono text-gray-700">1000</td>
                </tr>
                <tr className="border-b border-gray-50">
          ...
          <div className="text-[11px] text-gray-400">
            Each row represents one part number and its system quantity.
          </div>
        </div>
